...
const enUS = {
  ...
  settings: {
    ...
    ai: {
      ...
      streamLabel: 'Stream Output',
      streamDescription: 'When enabled, AI test and runtime calls will include stream=true.',
      failureThresholdLabel: 'AI consecutive failure threshold',
      failureThresholdDescription: 'When consecutive AI failures reach this value, the task will stop with an error.',
      failureThresholdPlaceholder: 'e.g. 3',
